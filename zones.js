// Auto-generated by Lerma Map Maker — 2026-04-02T10:51:14.160Z
...
export const ZONES = {
  ...
  panganiban: {
    ...
    portals:[
      ...
      { x:24, y:0, destZone:'concepcion', destX:24, destY:1, label:'Concepcion' }
    ],
    migs:null,
    defaultSpawn:{x:30,y:20},
  },
  ...
  concepcion: {
    ...
    portals:[
      { x:29, y:39, destZone:'panganiban', destX:29, destY:38, label:'Panganiban' }
    ],
    migs:null,
    defaultSpawn:{x:30,y:20},
  }
